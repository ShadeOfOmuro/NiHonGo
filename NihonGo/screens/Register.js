...
import {SafeAreaView ,Text , View , StyleSheet, TextInput , Image , ImageBackground, TouchableOpacity} from 'react-native'
      ...
      <SafeAreaView>
        <ImageBackground style={style.container} source={require('../assets/Images/Background.png')}>
          <View style={style.wrapper} >
            <Image style={style.login_logo} source={require('../assets/Images/RegisterLogo.png')}/>
            ...
            <Text style={style.label_username}>Re-Password</Text>   
            <TextInput secureTextEntry={true} onChangeText={(re_password)=> this.setState({re_password: re_password})} style={style.LoginBox} />
            <Text style={style.err_text}>{(this.state.false_password)? "Please Correct Your Information!" : "" }</Text> 
            <View style={{alignItems:"center"}}>
              <TouchableOpacity underlayColor="white" onPress={()=>{this.register()}}>
              ...
              <TouchableOpacity onPress={()=>{this.linker.push("Login")}}>
                <Text style={style.register_text}>Already have an account ?</Text>   
              </TouchableOpacity>
            </View>
          </View>
        </ImageBackground>       
