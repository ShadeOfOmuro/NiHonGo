      ...
      return (
        <View style={{flex : 1 , justifyContent : "center" , alignItems : "center" , backgroundColor : "#FFFFFF"}}>
          ...
          {this.state.chapterlist.map((chapter)=>
                    <View key={chapter[1]}>
                    <TouchableOpacity onPress={()=>{this.props.navigation.push("Chapter",{uid : this.props.route.params.uid,username : this.props.route.params.username,path_to_query : chapter[1]})}}>
                    <View style={style.pills}>
                        <Text style={{fontFamily:"Roboto-Bold",fontSize:18,color:"#FFFFFF"}}>{chapter[2]}</Text>
                    </View>
                    </TouchableOpacity>
                    </View>
                )}
