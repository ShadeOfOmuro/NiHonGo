...
const style = StyleSheet.create({
  ...
  second_incorrect : {
    ...
    fontFamily : "Roboto-Bold",
    fontSize : 36,
    transform : [{translateY : 193},{translateX : 55}],
    position : "absolute"
  },
  text_next : {
    color : "#FFFFFF",
        ...
        <View style={{flex : 1 , justifyContent : "center" , alignItems : "center" , backgroundColor : "#FEEFED"}}>
          ...
          <View style={style.nav_bar}>
            ...
            <Image source={require("../assets/Images/jp_flag.png")} style={{width : 40,height:40,borderRadius:400/2}}/>
              ...
              <TouchableOpacity onPress={()=>{this.clearscore()}}>
                <Image style={style.back_button} source={require("../assets/Images/BackButton.png")} />
              </TouchableOpacity>
            </View>
          </View>
          <Image style={style.title_image} source={require('../assets/Images/QGR.png')}/>
          <ScrollView>
            <View style={{alignItems : "center"}}>
            <Image style={style.result_padding} source={require('../assets/Images/Correct.png')}/>
            <Image  style={style.result_padding} source={require('../assets/Images/Incorrect.png')}/>
            <Text style={style.second_incorrect}>{(this.route_storage.type == "Game")? this.route_storage.num_items -(this.route_storage.score/100) : 20 - (this.route_storage.score/100)}</Text>
            <Text style={style.first_correct}>{this.route_storage.score/100}</Text>
            <TouchableOpacity onPress={()=>{this.clearscore()}}>
            <View style={style.next_button}>
              <Text style={style.text_next}>Continue</Text>
            </View>
            </TouchableOpacity>
            </View>
          </ScrollView>
