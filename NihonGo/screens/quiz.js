...
class QuizPage extends Component {
    ...
    state = {
      ...
      curr_choice_4 : "",
      curr_question_num : 0,
      quiz_payload : this.fetch_quiz("MEGA"),
      show_answer : false
    }
    next_question = (selected_choice) => {
        ...
        setTimeout(()=>{
            ...
            if(selected_choice == this.state.curr_correct_answer) {
                console.log("correct!");
                console.log(this.state.quiz_payload)
                if(this.state.curr_question_num+1 < 20) {
                    this.setState({
        ...
        <View style={{flex : 1 , justifyContent : "center" , alignItems : "center" , backgroundColor : "#FEEFED"}}>
          ...
          <View style={style.nav_bar}>
            <View style={style.Hstack_wrapper}> 
              ...
              <TouchableOpacity onPress={()=>{this.linker.push("QuizGameResult" ,{uid : this.route_storage.uid , username : this.route_storage.username , score : this.state.score_gained , type : "quiz"})}}>
